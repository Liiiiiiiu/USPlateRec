...
if __name__=="__main__":
    ...
    parser.add_argument('--image_path', type=str, default="/mnt/jx/data/trains", help='source') 
    parser.add_argument('--label_file', type=str, default='/mnt/jx/car_plate_rec/datasets/train.txt', help='model.pt path(s)')  
