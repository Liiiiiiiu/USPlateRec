...
if __name__ == "__main__":
    ...
    parser.add_argument('--onnx_file', type=str, default='/mnt/jx/car_plate_rec/onnx_jx/mid_88florida_val_1225.onnx', help='model.pt path(s)')#识别模型
    parser.add_argument('--image_path', type=str, default='/mnt/jx/data/trains/USA/Florida', help='source') 
